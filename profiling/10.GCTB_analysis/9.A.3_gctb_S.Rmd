...
snp0 <- read.csv("cache/snpeff/HN_asv_001659.csv") # Pseudomonas thivervalensis
snp0 <- read.csv("cache/snpeff/HN_asv_001416.csv") # Pseudomonas umsongensis
snp0 <- read.csv("cache/snpeff/LN_asv_000406.csv") # Massilia niabensis

snp0 <- read.csv("cache/snpeff/HN_asv_001529.csv") # Pseudomonas chlororaphis
snp0 <- read.csv("cache/snpeff/LN_asv_001529.csv") # Pseudomonas chlororaphis

snp0 <- read.csv("cache/snpeff/HN_asv_002138.csv") # Duganella radicis

snp0 <- read.csv("cache/snpeff/HN_asv_001294.csv") # Chitinophaga sancti
